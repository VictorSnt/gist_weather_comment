...
class CityQuery(BaseModel):
    ...
    def validate_location_rules(self) -> CityQuery:
        if bool(self.city) == bool(self.zipcode):
            raise ValueError("provide exactly one of city or zipcode")
